...
create_tool :: proc (game: ^og.Game) -> og.GameObject {
    ...
    og.add_component(tool, ecs.NewSpriteAnimator(sprite_comp = sc, sprites=io.new_tilesheet(game.assetsManager, "./assets/farm/objects&items/hoe-sheet.png",{16,16}).sprites))
